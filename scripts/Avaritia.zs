...
mods.tconstruct.Melting.addRecipe(<liquid:infinity>*144, <contenttweaker:infinityegg>);			
	...
	.chancedOutput(<roost:chicken>.withTag({Growth: 10, Chicken: "contenttweaker:infinitychicken", Gain: 10, Strength: 10}), 500, 200)
	.chancedOutput(<harvestcraft:scrambledeggitem>, 1500, 175)
	.chancedOutput(<ore:dustNetherStar>.firstItem, 5000, 750)
	.chancedOutput(<rftools:dimensional_shard>, 7500, 900)
    .duration(800)
    .EUt(384)
    .buildAndRegister();
